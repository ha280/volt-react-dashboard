...
export const CounterWidgetIP = (props) => {
        ...
        <Row className="d-block d-xl-flex align-items-center">
          <Col xs={12} xl={6} className="px-xl-0">
            <div className="d-none d-sm-block">
              <h5>{category}</h5>
              <h3 className="mb-1" style={{fontSize:"4rem",fontWeight:"800"}}>{title}</h3>
            </div>
...
export const CounterWidgetScore = (props) => {
  const { icon, iconColor, category, title, period, percentage } = props;
  const percentageIcon = percentage < 0 ? faAngleDown : faAngleUp;
  const percentageColor = percentage < 0 ? "text-danger" : "text-success";
    ...
    <Card border="light" className="shadow-sm">
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          ...
          <Row xs={12} xl={12} className="px-xl-0">
            <div className="d-none d-sm-block">
              <h3>{category}</h3>
              <h5>Hospital Average</h5>
              <h3 className="mb-1" style={{fontSize:"4rem",fontWeight:"800"}}>{title}</h3>
            </div>
            <div className="small mt-2">
              <FontAwesomeIcon icon={percentageIcon}className={`${percentageColor} me-1`} />
          ...
          <Row>
          <ProgressBar labelAlignment="outside" label={`63%`} style={{borderRadius:"20px",height:"20px",padding:"0"}}  now={63.7} key={1}/>
          </Row>
        </Row>
      </Card.Body>
    </Card>
