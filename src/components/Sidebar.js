...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faSignOutAlt, faTable, faTimes, faCalendarAlt, faMapPin, faInbox, faRocket, faClipboard, faExclamationTriangle, faClipboardCheck, faBars, faUser } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <NavItem title="Score Card" link={Routes.DashboardOverview.path} icon={faClipboard} />
              <NavItem external title="Risk Management" link="https://demo.themesberg.com/volt-pro-react/#/messages" target="_blank" icon={faExclamationTriangle} />
              <NavItem title="Prior Authorization" icon={faClipboardCheck} link={Routes.Transactions.path} />
              <NavItem title="Claims" icon={faBars} link={Routes.Settings.path} />
              <NavItem external title="My Profile" link="https://demo.themesberg.com/volt-pro-react/#/calendar" target="_blank" icon={faUser} />
